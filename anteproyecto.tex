...
\section{Análisis y diseños}
       ...
       \subsection{Casos de usos}\\
            ...
            \begin{figure}[H]
             \centering
             \includegraphics[width=0.8\textwidth]{iniciar-una-carrera}
            \end{figure}

            \begin{figure}[H]
             \centering
             \includegraphics[width=0.8\textwidth]{parar-una-carrera}
            \end{figure}

            \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{reanudar-una-carrera}
            \end{figure}

            \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{finalizar-una-carrera}
            \end{figure}

            \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{guardar-una-carrera}
            \end{figure}

            \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{no-guardar-una-carrera}
            \end{figure}

            \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{visualizar-una-carrera}
            \end{figure}

            \begin{figure}[H]
              \centering
              \includegraphics[width=0.8\textwidth]{visualizar-progreso}
            \end{figure}
